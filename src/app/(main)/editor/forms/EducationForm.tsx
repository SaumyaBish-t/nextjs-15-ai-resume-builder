...
import {KeyboardSensor, PointerSensor, useSensors,useSensor, DragEndEvent, DndContext, closestCenter} from "@dnd-kit/core";
...
function EducationItem({id,form,index,remove}:EducationItemProps){
    const {
        ...
        return <div className={cn("space-y-3 border rounded-md bg-background p-3",
